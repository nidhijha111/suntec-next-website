    ...
    <footer className="footer">
      ...
      <div>
        <div className="footer_info_text_wrapper">
          ...
          Shastri Marg, Bhandup West, Mumbai, Maharashtra 400078, Tel No. : 022
          45197023 I Email ID : care@suntecinsurance.com
        </div>
        ...
        <div className="footer_info_text_wrapper">
          <Image
            ...
            height={5} 
          />{" "}
          Suntec Insurance is registered as a Direct Insurance Broker (Life and
      ...
      <p className="copyright footer_info_text_wrapper">
        © Copyright 2026 - 2025 suntecinsurance.com. All Rights Reserved I
        Sitemap I FAQ’S
      </p>
    </footer>
  );
