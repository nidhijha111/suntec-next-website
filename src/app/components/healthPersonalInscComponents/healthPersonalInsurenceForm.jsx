...
export default function HealthPersonalInsurenceForm({type}) {
   ...
   const insuranceTypes = [
     {
       ...
       icon: "/assets/images/health_insurance_icon.svg",
     },
     {
       id: "Personal Accident Insurance",
       label: (
         <>
           Personal Accident <br /> Insurance
         </>
       ),
       icon: "/assets/images/personal_acciedent_icon.svg",
     },
   ];
