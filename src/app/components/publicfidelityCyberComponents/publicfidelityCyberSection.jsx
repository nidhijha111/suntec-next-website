    ...
    <div className="other-insurence-section">
      ...
      <InsuranceInfoSection
        ...
        paragraphs={[
          ...
          "Cyber Insurance, often called cybersecurity insurance, offers financial coverage for a wide range of cyber risks, such as unauthorized access to data, cyber extortion, identity theft, and network damage. It helps individuals and businesses manage the financial impact of cyber incidents often excluded from traditional insurance policies. ",
          "Whether you're a small business or a large enterprise, cyber insurance helps you respond to and recover from cyberattacks, while supporting proactive risk management and incident response. It safeguards your operations and demonstrates your commitment to data security, regulatory compliance, and customer trust—key pillars in today’s digital-first economy.",
        ]}
        desclaimer="For the detailed information about the products, please read the product information on the respective Insurer's website and to understand the policy coverage, please read the policy documents carefully.
"
      />
